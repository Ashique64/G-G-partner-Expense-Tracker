...
export const metadata = {
  title: "Grand & Grey — Partner Expense Tracker",
  description: "Internal financial management system for Grand & Grey partners. Real-time expense tracking and settlement.",
};
